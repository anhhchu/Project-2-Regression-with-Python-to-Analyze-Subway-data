# -*- coding: utf-8 -*-
"""
Created on Mon Aug 31 16:00:04 2015
...
def avg_medal_count():
    ...
    avg_bronze = numpy.mean(df['bronze'])
    avg_gold  = numpy.mean(df['gold'])
    avg_silver  = numpy.mean(df['silver'])
    avg_medal_count = Series([avg_bronze,avg_silver,avg_gold], index = ['bronze', 'silver', 'gold'])
